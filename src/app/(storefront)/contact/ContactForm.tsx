    ...
    <form action={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '24px', background: '#121212', padding: '40px', borderRadius: '24px', border: '1px solid #222' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
        ...
        <input 
          ...
          style={{ background: '#050505', border: '1px solid #333', padding: '14px 16px', borderRadius: '12px', color: defaultEmail ? '#888' : '#fff', fontSize: '15px' }}
        />
        {defaultEmail && <p style={{ fontSize: '12px', color: '#888' }}>Attached to your account.</p>}
      </div>
